...
const i18n = {
  ...
  ru: {
    ...
    instructions: {
      p1: "Ответьте на все 19 утверждений, выбрав вариант, который лучше всего описывает ваше состояние в последнее время.",
      p2: "Нет правильных или неправильных ответов. Будьте честны — это анонимно.",
      p3: "Вы увидите общий балл и три области с простыми объяснениями.",
      p4: "По желанию получите PDF с советами по электронной почте."
    },
    buttons: {
      start: "Начать",
      ...
      finish: "Завершить",
      previous: "Назад",
      pdf: "Получить мой PDF с советами",
    ...
    method: {
      title: "О Копенгагенском опроснике выгорания (CBI-19)",
      content: "Мы используем Копенгагенский опросник выгорания (CBI-19) с тремя областями: Личное, Работа, Связанное с клиентами выгорание. Баллы от 0 до 100 (выше = больше выгорания)."
    },
    progress: "отвечено",
    terminology: "Терминология:",
    results: {
      headline: "Ваш индекс выгорания: {overall}% — {band}",
      blurb: "Более высокие баллы означают более высокий риск выгорания. Ваш профиль предполагает:",
      personal: "Личное: {personal}% — {band}",
      work: "Работа: {work}% — {band}",
      patient: "Клиенты: {patient}% — {band}",
      nextSteps: "Следующие шаги:",
      tips: {
        personal: "Приоритизируйте сон, микро-перерывы для восстановления и снижение общей нагрузки на этой неделе.",
        work: "Попробуйте эксперимент с границами (ограничьте встречи, группируйте задачи) и обсудите с руководителем нагрузку и ценности.",
        patient: "Запланируйте debriefing и поддержку коллег; по возможности чередуйте сложные случаи; определите 'бюджет энергии' на день."
      }
    },
    email: {
      title: "Получите ваш персонализированный PDF-отчет",
      description: "Введите email, чтобы получить подробный PDF с вашими баллами, интерпретациями и персональными советами по восстановлению.",
      consent: "Отправьте мне мой PDF и периодические научно-обоснованные советы. Вы можете отписаться в любое время.",
...
// Current language (default to 'ru')
let currentLang = 'ru';
